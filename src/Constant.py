class Constant:
    ...
    # Path to dataset
    DATA_DIR = "/mnt/sun/levlevi/nba-plus-statvu-dataset/"  # currently points to sunflower server
    PLAYER_2D_POSITION = "2d-player-positions/"
    GAME_REPLAYS = "game-replays/"
    GAME_LOGS = "statvu-game-logs/"